...
int main(int argc, char** argv){
    ...
    MPI_Comm cart_comm;
    MPI_Cart_create(MPI_COMM_WORLD, 2, nprocdim, period, 1, &cart_comm);
    ...
    MPI_Scatterv(A, sendcounts, displs, sub_array_t, subA, nblock * nblock, MPI_DOUBLE, 0, MPI_COMM_WORLD);
    MPI_Scatterv(B, sendcounts, displs, sub_array_t, subB, nblock * nblock, MPI_DOUBLE, 0, MPI_COMM_WORLD);
    ...
    MPI_Gatherv(subC, nblock * nblock, MPI_DOUBLE, C, sendcounts, displs, sub_array_t, 0, MPI_COMM_WORLD);
